...
export const beneficiaries: Beneficiary[] = [
  { id: '1', firstName: 'Alice', lastName: 'Johnson', email: 'alice.j@example.com', avatar: getAvatar('avatar-1'), phoneNumber: '555-0101', category: 'Student', status: 'Active', totalPayments: 2500, paymentDate: '2023-05-20', lga: 'Ikeja', state: 'Lagos', class: 'SSS 3', paymentType: 'Termly Fees' },
  { id: '2', firstName: 'Bob', lastName: 'Williams', email: 'bob.w@example.com', avatar: getAvatar('avatar-2'), phoneNumber: '555-0102', category: 'Student', status: 'Active', totalPayments: 1800, paymentDate: '2023-05-18', lga: 'Abeokuta South', state: 'Ogun', class: 'JSS 1', paymentType: 'Registration' },
  ...
  { id: '6', firstName: 'Fiona', lastName: 'Wilson', email: 'fiona.w@example.com', avatar: getAvatar('avatar-6'), phoneNumber: '555-0106', category: 'Student', status: 'Active', totalPayments: 750, paymentDate: '2023-05-22', lga: 'Port Harcourt', state: 'Rivers', class: 'Primary 5', paymentType: 'Registration' },
];
